...
import { cableTypeLabel } from '../cables/type-label';
import { deviceTypeKey } from '../devices/naming';
import type { Language, TranslationKey } from './dictionaries';
import { formatI18nText } from './text';
