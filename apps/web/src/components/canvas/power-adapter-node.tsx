...
function PowerAdapterNodeImpl({ data }: NodeProps) {
  ...
  return (
    <div
      className="flex select-none items-center gap-2 rounded-md border border-neutral-600 bg-neutral-900/95 px-2.5 py-1.5 font-mono text-[11px] text-white shadow-2xl backdrop-blur-md"
      style={{
        width: PSU_CARD_W,
        height: PSU_CARD_H,
    ...
    >
      <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded bg-amber-500/20 text-[11px] font-bold text-amber-400">
        🔌
      </div>
      <div className="flex min-w-0 flex-col">
        <span className="truncate text-[9px] font-semibold uppercase leading-none tracking-wider text-neutral-400">
