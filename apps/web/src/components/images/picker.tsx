...
import { fileToCompressedDataUrl } from '../../lib/images/upload';
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div className="flex items-start gap-2.5">
        <div className="border-default-200 bg-surface-secondary flex h-14 w-14 shrink-0 items-center justify-center overflow-hidden rounded-lg border">
          {previewSrc ? (
            <img
              src={previewSrc}
              alt=""
              className="h-full w-full bg-black/20 object-contain p-0.5"
            />
          ) : (
            <ImageOff className="text-default-500 h-4 w-4" />
          )}
        </div>
          ...
          <div className="flex gap-1.5">
            ...
            {value && (
              <Button
                ...
                aria-label={t('imagePicker.removeBtn')}
              >
