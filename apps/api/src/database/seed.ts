...
async function main() {
  ...
  await authRepo.save(
    authRepo.create({ passphraseHash: bcrypt.hashSync('admin', 10), role: 'admin' }),
  );
  ...
  const setup = await setupRepo.save(
    setupRepo.create({
      ...
      description:
        '{"en": "Live inventory based on stage setup documentation.", "ru": "\\u0418\\u043d\\u0432\\u0435\\u043d\\u0442\\u0430\\u0440\\u044c \\u0438 \\u043a\\u043e\\u043c\\u043c\\u0443\\u0442\\u0430\\u0446\\u0438\\u044f \\u043d\\u0430 \\u043e\\u0441\\u043d\\u043e\\u0432\\u0435 \\u0442\\u0435\\u0445\\u043d\\u0438\\u0447\\u0435\\u0441\\u043a\\u043e\\u0439 \\u0434\\u043e\\u043a\\u0443\\u043c\\u0435\\u043d\\u0442\\u0430\\u0446\\u0438\\u0438 \\u0441\\u0446\\u0435\\u043d\\u044b."}',
    }),
  );
  ...
  const mkPort = (
    device: Device,
    overrides: Partial<CreatePortDto> & {
      name: string;
      portType: PortType;
  ...
  const mkAdapter = (
    overrides: Partial<CreateAdapterDto> & {
      name: string;
      inputType: PortType;
      outputType: PortType;
    },
  ...
  const mkCable = (
    overrides: Partial<CreateCableDto> & {
      sourcePortId: string;
      targetPortId: string;
      cableType: CableType;
      length: number;
  ...
  const mkFurniture = (
    overrides: Partial<CreateFurnitureDto> & { deviceId: string; kind: FurnitureKind },
  ...
  const venueOutlet1 = await mkDevice({
    ...
    notes:
      '{"en": "Stage left wall outlet \\u2014 where Andrey Anker extension cord connects.", "ru": "\\u0421\\u0442\\u0435\\u043d\\u0430/\\u0449\\u0438\\u0442\\u043e\\u043a \\u043f\\u043b\\u043e\\u0449\\u0430\\u0434\\u043a\\u0438 \\u2014 \\u043a\\u0443\\u0434\\u0430 \\u0432\\u0442\\u044b\\u043a\\u0430\\u0435\\u0442\\u0441\\u044f \\u0443\\u0434\\u043b\\u0438\\u043d\\u0438\\u0442\\u0435\\u043b\\u044c Anker \\u0441\\u0442\\u043e\\u0440\\u043e\\u043d\\u044b \\u0410\\u043d\\u0434\\u0440\\u0435\\u044f."}',
  });
  ...
  const venueOutlet2 = await mkDevice({
    ...
    notes:
      '{"en": "Stage right wall outlet \\u2014 where Dan Anker extension cord connects.", "ru": "\\u0421\\u0442\\u0435\\u043d\\u0430/\\u0449\\u0438\\u0442\\u043e\\u043a \\u043f\\u043b\\u043e\\u0449\\u0430\\u0434\\u043a\\u0438 \\u2014 \\u043a\\u0443\\u0434\\u0430 \\u0432\\u0442\\u044b\\u043a\\u0430\\u0435\\u0442\\u0441\\u044f \\u0443\\u0434\\u043b\\u0438\\u043d\\u0438\\u0442\\u0435\\u043b\\u044c Anker \\u0441\\u0442\\u043e\\u0440\\u043e\\u043d\\u044b \\u0414\\u0430\\u043d\\u0438-\\u0432\\u043e\\u043a\\u0430\\u043b\\u0430."}',
  });
  ...
  const venueOutlet3 = await mkDevice({
    ...
    notes:
      '{"en": "Dedicated wall outlet near combo amp.", "ru": "\\u041e\\u0442\\u0434\\u0435\\u043b\\u044c\\u043d\\u0430\\u044f \\u0440\\u043e\\u0437\\u0435\\u0442\\u043a\\u0430 \\u0441\\u0442\\u0435\\u043d\\u044b/\\u0449\\u0438\\u0442\\u043a\\u0430 \\u043f\\u043b\\u043e\\u0449\\u0430\\u0434\\u043a\\u0438 \\u043f\\u0440\\u044f\\u043c\\u043e \\u0443 \\u043a\\u043e\\u043c\\u0431\\u0438\\u043a\\u0430."}',
  });
  ...
  const anker1Plug = await mkPort(anker1, {
    name: 'Plug (venue outlet)',
    portType: PortType.POWER_SCHUKO,
  ...
  const anker2Plug = await mkPort(anker2, {
    name: 'Plug (venue outlet)',
    portType: PortType.POWER_SCHUKO,
    direction: PortDirection.IN,
    power: { currentType: CurrentType.AC },
  ...
  const anker2UsbA1 = await mkPort(anker2, {
    name: 'USB-A #1 (spare)',
    portType: PortType.USB_A,
    direction: PortDirection.OUT,
    power: { maxOutputPowerW: 12 },
  ...
  await mkCable({
    sourcePortId: venueOutlet1Port.id,
    targetPortId: anker1Plug.id,
    cableType: CableType.POWER_LINE,
    length: 1.5,
    color: 'white',
  });
  await mkCable({
    sourcePortId: venueOutlet2Port.id,
    targetPortId: anker2Plug.id,
    cableType: CableType.POWER_LINE,
    length: 1.5,
    color: 'white',
  });
  ...
  const pedalboard = await mkDevice({
    ...
    notes:
      '{"en": "Pedalboard setup \\u2014 see child devices below in signal chain order.", "ru": "\\u0421\\u043e\\u0441\\u0442\\u0430\\u0432 \\u043f\\u0435\\u0434\\u0430\\u043b\\u0435\\u0439 \\u2014 \\u0441\\u043c. \\u0434\\u043e\\u0447\\u0435\\u0440\\u043d\\u0438\\u0435 \\u0443\\u0441\\u0442\\u0440\\u043e\\u0439\\u0441\\u0442\\u0432\\u0430 \\u043d\\u0438\\u0436\\u0435 \\u0432 \\u043f\\u043e\\u0440\\u044f\\u0434\\u043a\\u0435 \\u0441\\u0438\\u0433\\u043d\\u0430\\u043b\\u044c\\u043d\\u043e\\u0439 \\u0446\\u0435\\u043f\\u0438."}',
  });
  ...
  const iso12ProIn = await mkPort(iso12pro, {
    name: 'Power In',
    portType: PortType.POWER_SCHUKO,
    direction: PortDirection.IN,
    power: { currentType: CurrentType.AC },
  ...
  const iso12Pro9vGroup = await mkPort(iso12pro, {
    ...
    power: {
      ...
      voltageV: 9,
      polarity: Polarity.CENTER_NEGATIVE,
      maxOutputCurrentMA: 300,
    },
  });
  await mkPort(iso12pro, {
    ...
    power: {
      ...
      voltageV: 12,
      polarity: Polarity.CENTER_NEGATIVE,
      maxOutputCurrentMA: 500,
    },
  });

  await mkCable({
    sourcePortId: anker1SchukoOuts[0].id,
    targetPortId: iso12ProIn.id,
    cableType: CableType.POWER_LINE,
    length: 1,
  });
  ...
  const andreyGuitarOut = await mkPort(andreyGuitar, {
    name: 'Jack Out',
  ...
  await mkDevice({
    ...
    notes:
      '{"en": "Clip-on tuner on headstock; piezo sensor is self-contained.", "ru": "\\u041a\\u0440\\u0435\\u043f\\u0438\\u0442\\u0441\\u044f \\u043f\\u0440\\u0438\\u0449\\u0435\\u043f\\u043a\\u043e\\u0439 \\u043d\\u0430 \\u0433\\u043e\\u043b\\u043e\\u0432\\u0443 \\u0433\\u0440\\u0438\\u0444\\u0430, \\u043f\\u044c\\u0435\\u0437\\u043e\\u0434\\u0430\\u0442\\u0447\\u0438\\u043a \\u0430\\u0432\\u0442\\u043e\\u043d\\u043e\\u043c\\u043d\\u044b\\u0439."}',
  });
  ...
  const andreyBass = await mkDevice({
    ...
    attrs: {
      ...
      model: 'JB-75MN SB Vintage Series',
      color: 'Sunburst',
    },
    notes:
      '{"en": "Used on select songs instead of guitar \\u2014 plugs into bass combo.", "ru": "\\u0418\\u0441\\u043f\\u043e\\u043b\\u044c\\u0437\\u0443\\u0435\\u0442\\u0441\\u044f \\u043d\\u0430 \\u043d\\u0435\\u043a\\u043e\\u0442\\u043e\\u0440\\u044b\\u0445 \\u043f\\u0435\\u0441\\u043d\\u044f\\u0445 \\u0432\\u043c\\u0435\\u0441\\u0442\\u043e \\u0433\\u0438\\u0442\\u0430\\u0440\\u044b \\u2014 \\u043f\\u043e\\u0434\\u043a\\u043b\\u044e\\u0447\\u0430\\u0435\\u0442\\u0441\\u044f \\u0432 \\u0431\\u0430\\u0441\\u043e\\u0432\\u044b\\u0439 \\u043a\\u043e\\u043c\\u0431\\u0438\\u043a."}',
  });
  const andreyBassOut = await mkPort(andreyBass, {
    name: 'Jack Out',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  ...
  const venueBassCombo = await mkDevice({
    ...
    notes:
      '{"en": "Provided by venue. Own cable.", "ru": "\\u041f\\u0440\\u0435\\u0434\\u043e\\u0441\\u0442\\u0430\\u0432\\u043b\\u044f\\u0435\\u0442\\u0441\\u044f \\u043f\\u043b\\u043e\\u0449\\u0430\\u0434\\u043a\\u043e\\u0439. \\u0428\\u043d\\u0443\\u0440 \\u0441\\u0432\\u043e\\u0439."}',
  });
  const venueBassComboIn = await mkPort(venueBassCombo, {
    name: 'Input',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  await mkCable({
    sourcePortId: andreyBassOut.id,
    targetPortId: venueBassComboIn.id,
  ...
  await mkDevice({
    ...
    notes:
      '{"en": "Included with Harley Benton SpaceShip 60XL pedalboard.", "ru": "\\u0418\\u0434\\u0451\\u0442 \\u0432 \\u043a\\u043e\\u043c\\u043f\\u043b\\u0435\\u043a\\u0442\\u0435 \\u043f\\u043e\\u0441\\u0442\\u0430\\u0432\\u043a\\u0438 \\u043f\\u0435\\u0434\\u0430\\u043b\\u0431\\u043e\\u0440\\u0434\\u0430 Harley Benton SpaceShip 60XL."}',
  });
  await mkDevice({
    ...
    attrs: {
      manufacturer: 'AZOR',
      model: 'Guitar Patch Cable 1/4 Inch 6-Pack Right Angle, 4 Inch (Multicolored)',
    },
    notes:
      '{"en": "Spare patch cable pack.", "ru": "\\u0424\\u0438\\u0437\\u0438\\u0447\\u0435\\u0441\\u043a\\u0438\\u0439 \\u0437\\u0430\\u043f\\u0430\\u0441\\u043d\\u043e\\u0439 \\u043a\\u043e\\u043c\\u043f\\u043b\\u0435\\u043a\\u0442 \\u043f\\u0430\\u0442\\u0447-\\u043a\\u0430\\u0431\\u0435\\u043b\\u0435\\u0439."}',
  });
  await mkFurniture({
    deviceId: pedalboard.id,
    kind: FurnitureKind.PEDALBOARD_CASE,
    isVenueProvided: false,
  });
  await mkFurniture({
    deviceId: andreyGuitar.id,
    kind: FurnitureKind.GUITAR_STAND,
    isVenueProvided: false,
  });
  ...
  const yellowCompIn = await mkPort(yellowComp, {
    name: 'Mono In',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  const yellowCompOut = await mkPort(yellowComp, {
    name: 'Mono Out',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  ...
  const cs400 = await mkDevice({
    ...
    attrs: {
      ...
      model: 'CS400',
      controls: [
        'LEVEL (MIN-MAX) — output level',
        'TONE (LO-HI) — treble tone control',
        'ATTACK (MIN-MAX) — attack time',
        'SUSTAIN (MIN-MAX) — sustain depth',
      ],
      footswitch: 'True Bypass',
    },
  });
  const cs400In = await mkPort(cs400, {
    name: 'Mono In',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  const cs400Out = await mkPort(cs400, {
    name: 'Mono Out',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  ...
  const to800 = await mkDevice({
    ...
    attrs: {
      ...
      model: 'TO800',
      controls: [
        'DRIVE (MIN-MAX) — overdrive gain level',
        'TONE (LO-HI) — mid frequency tone filter',
        'LEVEL (MIN-MAX) — output level',
      ],
      footswitch: 'True Bypass',
    },
  });
  const to800In = await mkPort(to800, {
    name: 'Mono In',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  const to800Out = await mkPort(to800, {
    name: 'Mono Out',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  ...
  const grunge = await mkDevice({
    ...
    attrs: {
      ...
      controls: [
        'LOUD — master volume',
        'LOW — bass response control',
        'HIGH — treble response control',
        'GRUNGE — gain structure level',
      ],
      footswitch: 'True Bypass',
    },
    notes:
      '{"en": "MIXER OUT MONO present physically but unused \\u2014 signal goes to AMP OUT.", "ru": "MIXER OUT MONO \\u043f\\u0440\\u0438\\u0441\\u0443\\u0442\\u0441\\u0442\\u0432\\u0443\\u0435\\u0442 \\u0444\\u0438\\u0437\\u0438\\u0447\\u0435\\u0441\\u043a\\u0438, \\u043d\\u043e \\u043d\\u0435 \\u0438\\u0441\\u043f\\u043e\\u043b\\u044c\\u0437\\u0443\\u0435\\u0442\\u0441\\u044f \\u2014 \\u0432 \\u0446\\u0435\\u043f\\u044c \\u0438\\u0434\\u0451\\u0442 AMP OUT."}',
  });
  const grungeIn = await mkPort(grunge, {
    name: 'Mono In',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  const grungeAmpOut = await mkPort(grunge, {
    name: 'Amp Out Mono',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  await mkPort(grunge, {
    name: 'Mixer Out Mono (unused)',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  ...
  const fs06 = await mkDevice({
    ...
    attrs: {
      ...
      controls: [
        ...
        'TREBLE',
        'LEVEL',
        'SAVE/SELECT — preset selection and save',
      ],
      footswitch: 'True Bypass',
      algorithms: [
  ...
  const fs06In = await mkPort(fs06, {
    name: 'Mono In',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  const fs06Out = await mkPort(fs06, {
    name: 'Mono Out',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  ...
  const fc14In = await mkPort(fc14, {
    name: 'Mono In',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  const fc14Out = await mkPort(fc14, {
    name: 'Mono Out',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  ...
  const jetEngineIn = await mkPort(jetEngine, {
    name: 'Mono In',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  const jetEngineOut = await mkPort(jetEngine, {
    name: 'Mono Out',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  ...
  const fs05 = await mkDevice({
    ...
    attrs: {
      ...
      controls: [
        'RATE',
        'DEPTH',
        'TYPE — 11-position rotary selector',
        'CTRL 1',
        'CTRL 2',
        'SAVE/SELECT',
      ],
  ...
  const fs05InL = await mkPort(fs05, {
    name: 'Mono In L',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  ...
  const fs05OutL = await mkPort(fs05, {
    name: 'Stereo Out L',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  const fs05OutR = await mkPort(fs05, {
    name: 'Stereo Out R',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  ...
  const dseed2 = await mkDevice({
    ...
    attrs: {
      ...
      controls: [
        'TYPE — effect/Looper selector',
        'TIME BEAT / LP.FX',
        'LEVEL / LP.LEVEL',
        'F.BACK / LP.TONE',
        'PingPong stereo mode toggle',
      ],
      footswitch:
      ...
      algorithms: [
        ...
        'Mod',
        'Reverse',
        'LOOPER — up to 3.5 min stereo, unlimited overdubs',
      ],
    },
  });
  const dseed2InL = await mkPort(dseed2, {
    name: 'Stereo In L',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  const dseed2InR = await mkPort(dseed2, {
    name: 'Stereo In R',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  const dseed2OutL = await mkPort(dseed2, {
    name: 'Stereo Out L',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  const dseed2OutR = await mkPort(dseed2, {
    name: 'Stereo Out R',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  ...
  const fs02InL = await mkPort(fs02, {
    name: 'Stereo In L',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  const fs02InR = await mkPort(fs02, {
    name: 'Stereo In R',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  const fs02OutL = await mkPort(fs02, {
    name: 'Stereo Out L',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  const fs02OutR = await mkPort(fs02, {
    name: 'Stereo Out R',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  ...
  const fs07 = await mkDevice({
    ...
    attrs: {
      ...
      controls: [
        'LEVEL',
        'LATENCY stereo phase adjustment',
        'HIGH CUT',
        'LOW CUT',
        'SAVE/SELECT',
        'Power Amp Sim toggle',
      ],
      algorithms: [
        'Fender Deluxe 1x12',
        'Vox AC30 2x12',
    ...
    notes:
      '{"en": "Supports third-party IR loading via Micro-USB.", "ru": "\\u041f\\u043e\\u0434\\u0434\\u0435\\u0440\\u0436\\u0438\\u0432\\u0430\\u0435\\u0442 \\u0437\\u0430\\u0433\\u0440\\u0443\\u0437\\u043a\\u0443 \\u0441\\u0442\\u043e\\u0440\\u043e\\u043d\\u043d\\u0438\\u0445 IR \\u0447\\u0435\\u0440\\u0435\\u0437 Micro-USB."}',
  });
  const fs07InL = await mkPort(fs07, {
    name: 'Stereo In L',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  const fs07InR = await mkPort(fs07, {
    name: 'Stereo In R',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  const fs07OutL = await mkPort(fs07, {
    name: 'Stereo Out L',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  const fs07OutR = await mkPort(fs07, {
    name: 'Stereo Out R',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  await mkPort(fs07, {
    name: 'Micro-USB (offline IR loading)',
    portType: PortType.USB_B,
  ...
  const AZOR_PATCH_CABLE =
    'AZOR Guitar Patch Cable 1/4 Inch 6-Pack Right Angle, 4 Inch Instrument Cables for Guitar Bass Effect Pedals (Multicolored)';
  ...
  for (const link of stereoPedalChain) {
    await mkCable({
      sourcePortId: link.outL.id,
      targetPortId: link.inL.id,
      cableType: CableType.AUDIO_UNBALANCED,
      length: 0.1,
      isPatchCable: true,
      productName: AZOR_PATCH_CABLE,
    });
    await mkCable({
      sourcePortId: link.outR.id,
      targetPortId: link.inR.id,
      cableType: CableType.AUDIO_UNBALANCED,
      length: 0.1,
      isPatchCable: true,
      productName: AZOR_PATCH_CABLE,
  ...
  for (const powerIn of [
    ...
    await mkCable({
      sourcePortId: iso12Pro9vGroup.id,
      targetPortId: powerIn.id,
      cableType: CableType.POWER_LINE,
      length: 0.15,
    });
  }
  ...
  const umcIn1 = await mkPort(umc404hd, {
    name: 'Combo In 1 (Pedalboard L)',
    portType: PortType.COMBO_XLR_TRS,
    direction: PortDirection.IN,
  });
  const umcIn2 = await mkPort(umc404hd, {
    name: 'Combo In 2 (Pedalboard R)',
    portType: PortType.COMBO_XLR_TRS,
    direction: PortDirection.IN,
  });
  await mkPort(umc404hd, {
    name: 'Combo In 3 (unused)',
    portType: PortType.COMBO_XLR_TRS,
    direction: PortDirection.IN,
  });
  await mkPort(umc404hd, {
    name: 'Combo In 4 (unused)',
    portType: PortType.COMBO_XLR_TRS,
    direction: PortDirection.IN,
  });
  const umcOutL = await mkPort(umc404hd, {
    name: 'Main Out L',
    portType: PortType.XLR_M,
    direction: PortDirection.OUT,
  });
  const umcOutR = await mkPort(umc404hd, {
    name: 'Main Out R',
    portType: PortType.XLR_M,
    direction: PortDirection.OUT,
  });
  for (let i = 1; i <= 4; i++) {
    await mkPort(umc404hd, {
      name: `Playback Out ${i} (unused)`,
      portType: PortType.TRS_14,
      direction: PortDirection.OUT,
    });
  }
  for (let i = 1; i <= 4; i++) {
    await mkPort(umc404hd, {
      name: `Analog Insert ${i} (unused)`,
      portType: PortType.TRS_14,
      direction: PortDirection.BI,
    });
  }
  const umcPhones = await mkPort(umc404hd, {
    name: 'Phones Out (stereo)',
    portType: PortType.TRS_14,
    direction: PortDirection.OUT,
  });
  await mkPort(umc404hd, {
    name: 'MIDI In (unused)',
    portType: PortType.MIDI_DIN,
    direction: PortDirection.IN,
  });
  await mkPort(umc404hd, {
    name: 'MIDI Out (unused)',
    portType: PortType.MIDI_DIN,
    direction: PortDirection.OUT,
  });
  const umcUsbB = await mkPort(umc404hd, {
    name: 'USB-B',
    portType: PortType.USB_B,
    direction: PortDirection.BI,
  });
  ...
  await mkCable({
    sourcePortId: fs07OutL.id,
    targetPortId: umcIn1.id,
    cableType: CableType.AUDIO_BALANCED,
    length: 1,
  });
  await mkCable({
    sourcePortId: fs07OutR.id,
    targetPortId: umcIn2.id,
    cableType: CableType.AUDIO_BALANCED,
    length: 1,
  });
  await mkCable({
    sourcePortId: anker1UsbA1.id,
    targetPortId: umcUsbB.id,
    cableType: CableType.USB_DATA,
    length: 1.5,
    adapterId: adapterUsbAtoB.id,
  });
  ...
  const mx400In1 = await mkPort(mx400, {
    name: 'Ch1 In (playback audio interface)',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  const mx400In2 = await mkPort(mx400, {
    name: 'Ch2 In (UMC404HD Phones, stereo→mono)',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  const mx400Out = await mkPort(mx400, {
    name: 'Mix Out',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  ...
  await mkCable({
    sourcePortId: umcPhones.id,
    targetPortId: mx400In2.id,
    cableType: CableType.AUDIO_UNBALANCED,
    length: 1,
  });
  await mkCable({
    sourcePortId: anker1SchukoOuts[1].id,
    targetPortId: mx400Power.id,
    cableType: CableType.POWER_LINE,
    length: 1.5,
    adapterId: adapterMx400Psu.id,
  });
  ...
  const palmer = await mkDevice({
    ...
    notes:
      '{"en": "Fully passive \\u2014 no power required.", "ru": "\\u041f\\u043e\\u043b\\u043d\\u043e\\u0441\\u0442\\u044c\\u044e \\u043f\\u0430\\u0441\\u0441\\u0438\\u0432\\u043d\\u044b\\u0439 \\u2014 \\u043f\\u0438\\u0442\\u0430\\u043d\\u0438\\u0435 \\u043d\\u0435 \\u0442\\u0440\\u0435\\u0431\\u0443\\u0435\\u0442\\u0441\\u044f."}',
  });
  const palmerInCombo = await mkPort(palmer, {
    name: 'Combo In (from MX400)',
    portType: PortType.COMBO_XLR_TRS,
    direction: PortDirection.IN,
  });
  await mkPort(palmer, {
    name: 'Mini-Jack In 3.5mm (unused)',
    portType: PortType.TRS_18,
    direction: PortDirection.IN,
  });
  await mkPort(palmer, {
    name: 'Out L (XLR)',
  ...
  const palmerOutMini = await mkPort(palmer, {
    name: 'Out (3.5mm, headphones)',
    portType: PortType.TRS_18,
    direction: PortDirection.OUT,
  });

  await mkCable({
    sourcePortId: mx400Out.id,
    targetPortId: palmerInCombo.id,
    cableType: CableType.AUDIO_UNBALANCED,
    length: 0.5,
  });
  ...
  const andreyHeadphonesIn = await mkPort(andreyHeadphones, {
    name: 'In',
    portType: PortType.TRS_18,
    direction: PortDirection.IN,
  });
  await mkCable({
    sourcePortId: palmerOutMini.id,
    targetPortId: andreyHeadphonesIn.id,
    cableType: CableType.AUDIO_UNBALANCED,
    length: 3,
  });
  await mkDevice({
    ...
    notes:
      '{"en": "Screw-on 1/4\\" TRS \\u2192 1/8\\" adapter for Andrey headphones.", "ru": "\\u0420\\u0435\\u0437\\u044c\\u0431\\u043e\\u0432\\u043e\\u0439 \\u043f\\u0435\\u0440\\u0435\\u0445\\u043e\\u0434\\u043d\\u0438\\u043a TRS 1/4\\" \\u2192 1/8\\" \\u0434\\u043b\\u044f \\u043d\\u0430\\u0443\\u0448\\u043d\\u0438\\u043a\\u043e\\u0432 \\u0410\\u043d\\u0434\\u0440\\u0435\\u044f."}',
  });
  ...
  const govee = await mkDevice({
    ...
    notes:
      '{"en": "Placed directly on stage.", "ru": "\\u0421\\u0442\\u0430\\u0432\\u0438\\u0442\\u0441\\u044f \\u043f\\u0440\\u044f\\u043c\\u043e \\u043d\\u0430 \\u0441\\u0446\\u0435\\u043d\\u0443."}',
  });
  ...
  await mkPort(govee, {
    name: 'Control Link (Wi-Fi/BLE/Matter)',
    portType: PortType.WIRELESS,
    direction: PortDirection.BI,
  });
  await mkCable({
    sourcePortId: anker1SchukoOuts[2].id,
    targetPortId: goveePower.id,
    cableType: CableType.POWER_LINE,
    length: 1,
    adapterId: adapterGoveePsu.id,
  });
  ...
  const danyaVMic = await mkDevice({
    ...
    notes:
      '{"en": "Band-owned microphone.", "ru": "\\u041d\\u0430\\u0448 \\u043c\\u0438\\u043a\\u0440\\u043e\\u0444\\u043e\\u043d (\\u043d\\u0435 \\u043f\\u043b\\u043e\\u0449\\u0430\\u0434\\u043a\\u0438)."}',
  });
  const danyaVMicOut = await mkPort(danyaVMic, {
    name: 'Out',
    portType: PortType.XLR_M,
    direction: PortDirection.OUT,
  });
  await mkFurniture({
    deviceId: danyaVMic.id,
    kind: FurnitureKind.MIC_STAND,
  ...
  const volt276 = await mkDevice({
    ...
    attrs: {
      ...
      controls: [
        'Vintage Preamp Switch',
        '76 Compressor presets (VOCAL, GTR, FAST, OFF)',
        'Direct Monitor',
      ],
    },
  });
  const volt276In1 = await mkPort(volt276, {
    name: 'Mic In (Combo)',
    portType: PortType.COMBO_XLR_TRS,
    direction: PortDirection.IN,
  });
  await mkPort(volt276, {
    name: 'In 2 (Combo, unused)',
    portType: PortType.COMBO_XLR_TRS,
    direction: PortDirection.IN,
  });
  const volt276Out1 = await mkPort(volt276, {
    name: 'Output 1 (Monitor/Phones)',
    portType: PortType.TRS_14,
    direction: PortDirection.OUT,
  });
  const volt276Out2 = await mkPort(volt276, {
    name: 'Output 2 (Line)',
    portType: PortType.TRS_14,
    direction: PortDirection.OUT,
  });
  ...
  const volt276UsbC = await mkPort(volt276, {
    name: 'USB-C Power',
    portType: PortType.USB_C,
    direction: PortDirection.BI,
  });
  ...
  await mkCable({
    sourcePortId: danyaVMicOut.id,
    targetPortId: volt276In1.id,
    cableType: CableType.AUDIO_BALANCED,
    length: 5,
    color: 'red',
  });
  await mkCable({
    sourcePortId: anker1UsbC.id,
    targetPortId: volt276UsbC.id,
    cableType: CableType.USB_DATA,
    length: 6,
  });
  ...
  const danyaVIemIn = await mkPort(danyaVIem, {
    name: 'In',
    portType: PortType.TRS_18,
    direction: PortDirection.IN,
  });
  ...
  const fex800 = await mkDevice({
    ...
    notes:
      '{"en": "Only original AC adapter.", "ru": "\\u0422\\u043e\\u043b\\u044c\\u043a\\u043e \\u0440\\u043e\\u0434\\u043d\\u043e\\u0439 AC-\\u0430\\u0434\\u0430\\u043f\\u0442\\u0435\\u0440."}',
  });
  const fex800InL = await mkPort(fex800, {
    name: 'In L',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  ...
  const fex800OutL = await mkPort(fex800, {
    name: 'Out L',
    portType: PortType.TRS_14,
    direction: PortDirection.OUT,
  });
  const fex800OutR = await mkPort(fex800, {
    name: 'Out R',
    portType: PortType.TRS_14,
    direction: PortDirection.OUT,
  });
  ...
  await mkCable({
    sourcePortId: volt276Out2.id,
    targetPortId: fex800InL.id,
    cableType: CableType.AUDIO_UNBALANCED,
    length: 2,
  });
  await mkCable({
    sourcePortId: anker2SchukoOuts[0].id,
    targetPortId: fex800Power.id,
    cableType: CableType.POWER_LINE,
    length: 1.5,
    adapterId: adapterFex800Psu.id,
  });
  ...
  const danyaVGuitar = await mkDevice({
    ...
    notes:
      '{"en": "Used on select songs.", "ru": "\\u0418\\u0441\\u043f\\u043e\\u043b\\u044c\\u0437\\u0443\\u0435\\u0442\\u0441\\u044f \\u043d\\u0435 \\u043d\\u0430 \\u0432\\u0441\\u0435\\u0445 \\u043f\\u0435\\u0441\\u043d\\u044f\\u0445."}',
  });
  const danyaVGuitarOut = await mkPort(danyaVGuitar, {
    name: 'Jack Out',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  await mkFurniture({
    deviceId: danyaVGuitar.id,
    kind: FurnitureKind.GUITAR_STAND,
    isVenueProvided: false,
  });
  ...
  const tu3 = await mkDevice({
    ...
    attrs: {
      ...
      controls: [
        ...
        'Stream/Cent tuning mode',
        'Flat tuning support (up to 6 semitones down)',
      ],
      footswitch: 'True Bypass',
    },
    notes:
  ...
  const tu3In = await mkPort(tu3, {
    name: 'Input (guitar)',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  const tu3Out = await mkPort(tu3, {
    name: 'Output (mute tuning)',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  ...
  const danyaVPsu1In = await mkPort(danyaVPsu1, {
    name: 'Power In',
    portType: PortType.POWER_SCHUKO,
    direction: PortDirection.IN,
    power: { currentType: CurrentType.AC },
  ...
  await mkCable({
    sourcePortId: anker2SchukoOuts[1].id,
    targetPortId: danyaVPsu1In.id,
    cableType: CableType.POWER_LINE,
    length: 1,
  });
  await mkCable({
    sourcePortId: danyaVPsu1Out.id,
    targetPortId: tu3Power.id,
    cableType: CableType.POWER_LINE,
    length: 0.3,
  });
  ...
  const danyaVPsu2 = await mkDevice({
    ...
    power: { currentType: CurrentType.DC, voltageV: 9, maxOutputCurrentMA: 200 },
    notes:
      '{"en": "Single channel PSU powering TC Electronic Cinders.", "ru": "\\u041e\\u0434\\u043d\\u043e\\u043a\\u0430\\u043d\\u0430\\u043b\\u044c\\u043d\\u044b\\u0439 \\u0411\\u041f \\u2014 \\u043f\\u0438\\u0442\\u0430\\u0435\\u0442 \\u0442\\u043e\\u043b\\u044c\\u043a\\u043e TC Electronic Cinders."}',
  });
  const danyaVPsu2In = await mkPort(danyaVPsu2, {
    name: 'Power In',
    portType: PortType.POWER_SCHUKO,
    direction: PortDirection.IN,
    power: { currentType: CurrentType.AC },
  ...
  await mkCable({
    sourcePortId: anker2SchukoOuts[4].id,
    targetPortId: danyaVPsu2In.id,
    cableType: CableType.POWER_LINE,
    length: 1,
  });
  ...
  const cindersIn = await mkPort(cinders, {
    name: 'Input',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  const cindersOut = await mkPort(cinders, {
    name: 'Output',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  ...
  await mkCable({
    sourcePortId: danyaVPsu2Out.id,
    targetPortId: cindersPower.id,
    cableType: CableType.POWER_LINE,
    length: 0.3,
  });
  ...
  const fc03In = await mkPort(fc03, {
    name: 'Input',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  const fc03Out = await mkPort(fc03, {
    name: 'Output',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  ...
  await mkCable({
    sourcePortId: tu3DaisyOut.id,
    targetPortId: fc03Power.id,
    cableType: CableType.POWER_LINE,
    length: 0.3,
  });
  ...
  const danyaVCombo = await mkDevice({
    ...
    notes:
      '{"en": "Mic for guitar combo amp.", "ru": "\\u041f\\u043e\\u0434\\u0437\\u0432\\u0443\\u0447\\u043a\\u0430 \\u0441\\u043d\\u0438\\u043c\\u0430\\u0435\\u0442\\u0441\\u044f \\u0434\\u0438\\u043d\\u0430\\u043c\\u0438\\u0447\\u0435\\u0441\\u043a\\u0438\\u043c \\u043c\\u0438\\u043a\\u0440\\u043e\\u0444\\u043e\\u043d\\u043e\\u043c Sennheiser e835s."}',
  });
  const danyaVComboIn = await mkPort(danyaVCombo, {
    name: 'Input',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  await mkPort(danyaVCombo, {
    name: 'FX Loop Send (unused)',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  await mkPort(danyaVCombo, {
    name: 'FX Loop Return (unused)',
    portType: PortType.TS_14,
    direction: PortDirection.IN,
  });
  await mkPort(danyaVCombo, {
    name: 'Speaker Out (4/8/16 Ω, unused)',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  const danyaVComboPower = await mkPort(danyaVCombo, {
    name: 'Power In',
    portType: PortType.POWER_SCHUKO,
    direction: PortDirection.IN,
    power: { currentType: CurrentType.AC },
  ...
  await mkCable({
    sourcePortId: venueOutlet3Port.id,
    targetPortId: danyaVComboPower.id,
    cableType: CableType.POWER_LINE,
    length: 2,
  });

  await mkCable({
    sourcePortId: danyaVGuitarOut.id,
    targetPortId: pedalPorts[0].in.id,
    cableType: CableType.AUDIO_UNBALANCED,
    length: 0.3,
  });
  await mkCable({
    sourcePortId: pedalPorts[0].out.id,
    targetPortId: pedalPorts[1].in.id,
    cableType: CableType.AUDIO_UNBALANCED,
    length: 0.2,
    isPatchCable: true,
  });
  await mkCable({
    sourcePortId: pedalPorts[1].out.id,
    targetPortId: pedalPorts[2].in.id,
    cableType: CableType.AUDIO_UNBALANCED,
    length: 0.2,
    isPatchCable: true,
  });
  await mkCable({
    sourcePortId: pedalPorts[2].out.id,
    targetPortId: danyaVComboIn.id,
    cableType: CableType.AUDIO_UNBALANCED,
    length: 0.5,
  });
  ...
  const e835s = await mkDevice({
    ...
    notes:
      '{"en": "Mic stand in front of combo speaker.", "ru": "\\u0421\\u0442\\u043e\\u0439\\u043a\\u0430 \\u0441 \\u043c\\u0438\\u043a\\u0440\\u043e\\u0444\\u043e\\u043d\\u043e\\u043c \\u0440\\u0430\\u0441\\u043f\\u043e\\u043b\\u043e\\u0436\\u0435\\u043d\\u0430 \\u043f\\u0435\\u0440\\u0435\\u0434 \\u0434\\u0438\\u0444\\u0444\\u0443\\u0437\\u043e\\u0440\\u043e\\u043c \\u043a\\u043e\\u043c\\u0431\\u0438\\u043a\\u0430."}',
  });
  const e835sOut = await mkPort(e835s, {
    name: 'Out',
    portType: PortType.XLR_M,
    direction: PortDirection.OUT,
  });
  ...
  const playbackLaptop = await mkDevice({
    ...
    notes:
      '{"en": "Main playback laptop.", "ru": "\\u041e\\u0441\\u043d\\u043e\\u0432\\u043d\\u043e\\u0439 \\u043d\\u043e\\u0443\\u0442\\u0431\\u0443\\u043a \\u0434\\u043b\\u044f \\u0432\\u043e\\u0441\\u043f\\u0440\\u043e\\u0438\\u0437\\u0432\\u0435\\u0434\\u0435\\u043d\\u0438\\u044f \\u043f\\u043b\\u0435\\u0439\\u0431\\u0435\\u043a\\u043e\\u0432 \\u0438 \\u0443\\u043f\\u0440\\u0430\\u0432\\u043b\\u0435\\u043d\\u0438\\u044f \\u0441\\u0446\\u0435\\u043d\\u043e\\u0439."}',
  });
  const playbackLaptopUsbC = await mkPort(playbackLaptop, {
    name: 'USB-C / TB4',
    portType: PortType.USB_C,
    direction: PortDirection.BI,
  });
  const playbackLaptopPowerIn = await mkPort(playbackLaptop, {
    name: 'MagSafe / USB-C Power In',
    portType: PortType.POWER_SCHUKO,
    direction: PortDirection.IN,
  });
  ...
  const playbackLaptopPsu = await mkDevice({
    ...
    notes:
      '{"en": "140W power supply for Dan playback laptop.", "ru": "\\u0420\\u043e\\u0434\\u043d\\u043e\\u0439 \\u0431\\u043b\\u043e\\u043a \\u043f\\u0438\\u0442\\u0430\\u043d\\u0438\\u044f 140W \\u0434\\u043b\\u044f \\u043d\\u043e\\u0443\\u0442\\u0431\\u0443\\u043a\\u0430 \\u043f\\u043b\\u0435\\u0439\\u0431\\u0435\\u043a\\u043e\\u0432 \\u0414\\u0430\\u043d\\u0438-\\u0432\\u043e\\u043a\\u0430\\u043b\\u0430."}',
  });
  const playbackLaptopPsuPlug = await mkPort(playbackLaptopPsu, {
    name: 'Plug (to Anker)',
    portType: PortType.POWER_SCHUKO,
    direction: PortDirection.IN,
  });
  const playbackLaptopPsuOut = await mkPort(playbackLaptopPsu, {
    name: 'USB-C Out (140W)',
    portType: PortType.USB_C,
    direction: PortDirection.OUT,
    power: { maxOutputPowerW: 140 },
  });

  await mkCable({
    sourcePortId: anker2SchukoOuts[3].id,
    targetPortId: playbackLaptopPsuPlug.id,
    cableType: CableType.POWER_LINE,
    length: 1.5,
    color: 'black',
  });
  await mkCable({
    sourcePortId: playbackLaptopPsuOut.id,
    targetPortId: playbackLaptopPowerIn.id,
    cableType: CableType.POWER_LINE,
    length: 2,
    color: 'white',
  });
  ...
  const motu = await mkDevice({
    ...
    notes:
      '{"en": "Power supply polarity ANY.", "ru": "\\u041f\\u043e\\u043b\\u044f\\u0440\\u043d\\u043e\\u0441\\u0442\\u044c \\u0431\\u043b\\u043e\\u043a\\u0430 \\u043f\\u0438\\u0442\\u0430\\u043d\\u0438\\u044f \\u0443\\u0441\\u0442\\u0440\\u043e\\u0439\\u0441\\u0442\\u0432\\u0443 \\u0431\\u0435\\u0437\\u0440\\u0430\\u0437\\u043b\\u0438\\u0447\\u043d\\u0430 (ANY)."}',
  });
  const motuUsbB = await mkPort(motu, {
    name: 'USB-B',
    portType: PortType.USB_B,
    direction: PortDirection.BI,
  });
  await mkPort(motu, {
    name: 'Combo Mic/Guitar In 1 (unused)',
    portType: PortType.COMBO_XLR_TRS,
    direction: PortDirection.IN,
  });
  await mkPort(motu, {
    name: 'Combo Mic/Guitar In 2 (unused)',
    portType: PortType.COMBO_XLR_TRS,
    direction: PortDirection.IN,
  });
  for (let i = 1; i <= 6; i++) {
    await mkPort(motu, {
      name: `Line In ${i} (unused)`,
      portType: PortType.TRS_14,
      direction: PortDirection.IN,
    });
  }
  const motuOutBassL = await mkPort(motu, {
    name: 'Out — Bass L',
    portType: PortType.TRS_14,
    direction: PortDirection.OUT,
  });
  const motuOutBassR = await mkPort(motu, {
    name: 'Out — Bass R',
    portType: PortType.TRS_14,
    direction: PortDirection.OUT,
  });
  const motuOutPercL = await mkPort(motu, {
    name: 'Out — Percussion L',
    portType: PortType.TRS_14,
    direction: PortDirection.OUT,
  });
  const motuOutPercR = await mkPort(motu, {
    name: 'Out — Percussion R',
    portType: PortType.TRS_14,
    direction: PortDirection.OUT,
  });
  const motuOutSynthL = await mkPort(motu, {
    name: 'Out — Synths/BVs L',
    portType: PortType.TRS_14,
    direction: PortDirection.OUT,
  });
  const motuOutSynthR = await mkPort(motu, {
    name: 'Out — Synths/BVs R',
    portType: PortType.TRS_14,
    direction: PortDirection.OUT,
  });
  const motuOutAux = await mkPort(motu, {
    name: 'Aux Out (drummer click)',
    portType: PortType.TRS_18,
    direction: PortDirection.OUT,
  });
  const motuOutMonitorFeed = await mkPort(motu, {
    name: 'Line Out (monitor feed)',
    portType: PortType.TS_14,
    direction: PortDirection.OUT,
  });
  await mkPort(motu, {
    name: 'S/PDIF In (unused)',
    portType: PortType.TRS_14,
    direction: PortDirection.IN,
  });
  await mkPort(motu, {
    name: 'S/PDIF Out (unused)',
    portType: PortType.TRS_14,
    direction: PortDirection.OUT,
  });
  await mkPort(motu, {
    name: 'Optical In (unused)',
    portType: PortType.TRS_14,
    direction: PortDirection.IN,
  });
  await mkPort(motu, {
    name: 'Optical Out (unused)',
    portType: PortType.TRS_14,
    direction: PortDirection.OUT,
  });
  await mkPort(motu, {
  ...
  const motuMidiOut = await mkPort(motu, {
    name: 'MIDI Out',
    portType: PortType.MIDI_DIN,
    direction: PortDirection.OUT,
  });
  ...
  await mkCable({
    sourcePortId: playbackLaptopUsbC.id,
    targetPortId: motuUsbB.id,
    cableType: CableType.USB_DATA,
    length: 1.5,
    adapterId: adapterUsbCtoB.id,
  });
  await mkCable({
    sourcePortId: anker2SchukoOuts[2].id,
    targetPortId: motuPower.id,
    cableType: CableType.POWER_LINE,
    length: 2,
    adapterId: adapterMotuPsu.id,
  });
  await mkCable({
  ...
  const synthLaptop = await mkDevice({
    ...
    notes:
      '{"en": "Andrey laptop for soft-synths and virtual keys.", "ru": "\\u041d\\u043e\\u0443\\u0442\\u0431\\u0443\\u043a \\u0410\\u043d\\u0434\\u0440\\u0435\\u044f \\u0434\\u043b\\u044f \\u0441\\u043e\\u0444\\u0442-\\u0441\\u0438\\u043d\\u0442\\u0435\\u0437\\u0430\\u0442\\u043e\\u0440\\u043e\\u0432 \\u0438 \\u0432\\u0438\\u0440\\u0442\\u0443\\u0430\\u043b\\u044c\\u043d\\u044b\\u0445 \\u043a\\u043b\\u0430\\u0432\\u0438\\u0448\\u043d\\u044b\\u0445 \\u0438\\u043d\\u0441\\u0442\\u0440\\u0443\\u043c\\u0435\\u043d\\u0442\\u043e\\u0432."}',
  });
  const synthLaptopPowerIn = await mkPort(synthLaptop, {
    name: 'USB-C Power In',
    portType: PortType.POWER_SCHUKO,
    direction: PortDirection.IN,
  });
  const synthLaptopUsbC = await mkPort(synthLaptop, {
    name: 'USB-C (MIDI/Audio)',
    portType: PortType.USB_C,
    direction: PortDirection.BI,
  });
  ...
  const synthLaptopPsu = await mkDevice({
    ...
    notes:
      '{"en": "Compact Anker GaN charger.", "ru": "\\u0417\\u0430\\u0440\\u044f\\u0434\\u043a\\u0430 \\u0441\\u0438\\u043d\\u0442\\u0435\\u0437\\u0430\\u0442\\u043e\\u0440\\u043d\\u043e\\u0433\\u043e \\u043d\\u043e\\u0443\\u0442\\u0431\\u0443\\u043a\\u0430 \\u0410\\u043d\\u0434\\u0440\\u0435\\u044f \\u2014 \\u043a\\u043e\\u043c\\u043f\\u0430\\u043a\\u0442\\u043d\\u044b\\u0439 Anker GaN charger."}',
  });
  const synthLaptopPsuPlug = await mkPort(synthLaptopPsu, {
    name: 'Plug (to Anker)',
    portType: PortType.POWER_SCHUKO,
    direction: PortDirection.IN,
  });
  const synthLaptopPsuOut = await mkPort(synthLaptopPsu, {
    name: 'USB-C Out (140W)',
    portType: PortType.USB_C,
    direction: PortDirection.OUT,
    power: { maxOutputPowerW: 140 },
  ...
  await mkCable({
    sourcePortId: anker1SchukoOuts[3].id,
    targetPortId: synthLaptopPsuPlug.id,
    cableType: CableType.POWER_LINE,
    length: 1.5,
    color: 'black',
  });
  await mkCable({
    sourcePortId: synthLaptopPsuOut.id,
    targetPortId: synthLaptopPowerIn.id,
    cableType: CableType.POWER_LINE,
    length: 2,
    color: 'white',
  });
  ...
  const cmeSyncBox = await mkDevice({
    ...
    notes:
      '{"en": "MIDI synchronizer: receives MIDI clock from MOTU and sends to UMC404HD and keys.", "ru": "\\u041c\\u0438\\u0434\\u0438-\\u0441\\u0438\\u043d\\u0445\\u0440\\u043e\\u043d\\u0438\\u0437\\u0430\\u0442\\u043e\\u0440: \\u043f\\u0440\\u0438\\u043d\\u0438\\u043c\\u0430\\u0435\\u0442 MIDI-\\u043a\\u043b\\u043e\\u043a \\u0438\\u0437 MOTU \\u0438 \\u0440\\u0430\\u0437\\u0434\\u0430\\u0451\\u0442 \\u043d\\u0430 UMC404HD \\u0438 \\u043a\\u043b\\u0430\\u0432\\u0438\\u0448\\u0438."}',
  });
  const cmePowerIn = await mkPort(cmeSyncBox, {
    name: 'USB-C Power In (5V DC)',
    portType: PortType.USB_C,
    direction: PortDirection.IN,
    power: { voltageV: 5, currentType: CurrentType.DC },
  });
  const cmeMidiIn = await mkPort(cmeSyncBox, {
    name: 'MIDI IN',
    portType: PortType.MIDI_DIN,
    direction: PortDirection.IN,
  });
  const cmeMidiOut1 = await mkPort(cmeSyncBox, {
    name: 'MIDI OUT 1',
    portType: PortType.MIDI_DIN,
    direction: PortDirection.OUT,
  });
  await mkPort(cmeSyncBox, {
    name: 'MIDI OUT 2 (unused)',
    portType: PortType.MIDI_DIN,
    direction: PortDirection.OUT,
  });
  ...
  // CME Power cable
  await mkCable({
    sourcePortId: anker2UsbA1.id,
    targetPortId: cmePowerIn.id,
    cableType: CableType.POWER_LINE,
    length: 1.5,
  });
  ...
  await mkCable({
    sourcePortId: motuMidiOut.id,
    targetPortId: cmeMidiIn.id,
    cableType: CableType.MIDI,
    length: 3,
    color: 'orange',
  });
  const umcMidiIn = await mkPort(umc404hd, {
    name: 'MIDI In (Sync)',
    portType: PortType.MIDI_DIN,
    direction: PortDirection.IN,
  });
  await mkCable({
    sourcePortId: cmeMidiOut1.id,
    targetPortId: umcMidiIn.id,
    cableType: CableType.MIDI,
    length: 5,
    color: 'orange',
  });
  ...
  const danyaDIem = await mkDevice({
    ...
    position: { x: 1400, y: 0 },
    notes:
      '{"en": "Standalone IEM system with full monitor mix + click.", "ru": "\\u0412\\u043a\\u043b\\u044e\\u0447\\u0430\\u0435\\u0442 \\u043f\\u043e\\u043b\\u043d\\u044b\\u0439 \\u043c\\u043e\\u043d\\u0438\\u0442\\u043e\\u0440\\u043d\\u044b\\u0439 \\u043c\\u0438\\u043a\\u0441 + \\u043a\\u043b\\u0438\\u043a."}',
  });
  const danyaDIemIn = await mkPort(danyaDIem, {
    name: 'Aux In',
    portType: PortType.TRS_18,
    direction: PortDirection.IN,
  });
  await mkCable({
    sourcePortId: motuOutAux.id,
    targetPortId: danyaDIemIn.id,
    cableType: CableType.AUDIO_UNBALANCED,
    length: 8,
  });
  ...
  const ch = async (name: string, portType: PortType) =>
    mkPort(stageBox, { name, portType, direction: PortDirection.IN });
  ...
  await mkCable({
    sourcePortId: motuOutBassL.id,
    targetPortId: ch01.id,
    cableType: CableType.AUDIO_BALANCED,
    length: 3,
    adapterId: adapterTrsToXlr.id,
  });
  await mkCable({
    sourcePortId: motuOutBassR.id,
    targetPortId: ch02.id,
    cableType: CableType.AUDIO_BALANCED,
    length: 3,
    adapterId: adapterTrsToXlr.id,
  });
  await mkCable({
    sourcePortId: motuOutPercL.id,
    targetPortId: ch03.id,
    cableType: CableType.AUDIO_BALANCED,
    length: 3,
    adapterId: adapterTrsToXlr.id,
  });
  await mkCable({
    sourcePortId: motuOutPercR.id,
    targetPortId: ch04.id,
    cableType: CableType.AUDIO_BALANCED,
    length: 3,
    adapterId: adapterTrsToXlr.id,
  });
  await mkCable({
    sourcePortId: motuOutSynthL.id,
    targetPortId: ch05.id,
    cableType: CableType.AUDIO_BALANCED,
    length: 3,
    adapterId: adapterTrsToXlr.id,
  });
  await mkCable({
    sourcePortId: motuOutSynthR.id,
    targetPortId: ch06.id,
    cableType: CableType.AUDIO_BALANCED,
    length: 3,
    adapterId: adapterTrsToXlr.id,
  });
  ...
  await mkCable({
    sourcePortId: fex800OutL.id,
    targetPortId: ch07.id,
    cableType: CableType.AUDIO_UNBALANCED,
    length: 5,
    isUserOwned: false,
  });
  await mkCable({
    sourcePortId: fex800OutR.id,
    targetPortId: ch08.id,
    cableType: CableType.AUDIO_UNBALANCED,
    length: 5,
    isUserOwned: false,
  });
  await mkCable({
    sourcePortId: umcOutL.id,
    targetPortId: ch09.id,
    cableType: CableType.AUDIO_BALANCED,
    length: 6,
    color: 'blue',
  });
  await mkCable({
    sourcePortId: umcOutR.id,
    targetPortId: ch10.id,
    cableType: CableType.AUDIO_BALANCED,
    length: 6,
    color: 'green',
  });
  await mkCable({
    sourcePortId: e835sOut.id,
    targetPortId: ch11.id,
    cableType: CableType.AUDIO_BALANCED,
    length: 5,
  });

  await mkFurniture({
    deviceId: playbackLaptop.id,
  ...
  const keyboard = await mkDevice({
    ...
    notes:
      '{"en": "MIDI keyboard controller connected via USB-C to synth laptop.", "ru": "MIDI-\\u043a\\u043e\\u043d\\u0442\\u0440\\u043e\\u043b\\u043b\\u0435\\u0440 \\u043a\\u043b\\u0430\\u0432\\u0438\\u0448, \\u043f\\u043e\\u0434\\u043a\\u043b\\u044e\\u0447\\u0430\\u0435\\u0442\\u0441\\u044f \\u043f\\u043e USB-C \\u043a \\u0441\\u0438\\u043d\\u0442\\u0435\\u0437\\u0430\\u0442\\u043e\\u0440\\u043d\\u043e\\u043c\\u0443 \\u043d\\u043e\\u0443\\u0442\\u0431\\u0443\\u043a\\u0443 \\u0410\\u043d\\u0434\\u0440\\u0435\\u044f."}',
  });
  const keyboardUsbC = await mkPort(keyboard, {
    name: 'USB-C',
    portType: PortType.USB_C,
    direction: PortDirection.BI,
  });
  await mkFurniture({
    deviceId: keyboard.id,
    kind: FurnitureKind.KEYBOARD_STAND,
    isVenueProvided: false,
  });

  await mkCable({
    sourcePortId: keyboardUsbC.id,
    targetPortId: synthLaptopUsbC.id,
    cableType: CableType.USB_DATA,
    length: 1.5,
  });
